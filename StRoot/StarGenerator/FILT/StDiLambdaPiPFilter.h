#ifndef StDiLambdaPiPFilter_h
#define StDiLambdaPiPFilter_h
...
class StDiLambdaPiPFilter : public StarFilterMaker
{
public:
  StDiLambdaPiPFilter(  );
  virtual ~StDiLambdaPiPFilter();
...
//#if 1 // we dont really need, but this triggers cons to create dictionary
  ClassDef(StDiLambdaPiPFilter,0);
//#endif
