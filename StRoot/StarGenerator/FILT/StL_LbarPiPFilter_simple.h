#ifndef StL_LbarPiPFilter_simple_h
#define StL_LbarPiPFilter_simple_h
...
class StL_LbarPiPFilter_simple : public StarFilterMaker
{
public:
  StL_LbarPiPFilter_simple(  );
  virtual ~StL_LbarPiPFilter_simple();
...
//#if 1 // we dont really need, but this triggers cons to create dictionary
  ClassDef(StL_LbarPiPFilter_simple,0);
//#endif
