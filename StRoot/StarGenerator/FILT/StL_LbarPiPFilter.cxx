...
StL_LbarPiPFilter::StL_LbarPiPFilter():StarFilterMaker("LambdaPiP")
{
...
//_______________________________________________________________
StL_LbarPiPFilter::~StL_LbarPiPFilter()
{
	delete nEvents;
}
//_______________________________________________________________
Int_t StL_LbarPiPFilter::Filter( StarGenEvent *mEvent )
{
	...
	if(mDaughterKineFlag)
  {
	...
	if (
      ...
      || //this should make sure there is L-Lbar pair in the event, for single L(Lbar), && was used
			(
...
void  StL_LbarPiPFilter::SetDauKine(double ptMin1, double ptMax1, double etaMin1, double etaMax1, double phiMin1, double phiMax1, double ptMin2, double ptMax2, double etaMin2, double etaMax2, double phiMin2, double phiMax2)
{
...
void StL_LbarPiPFilter::SetParentRapidities(double yMin1, double yMax1, double yMin2, double yMax2)
{
	mParent1YMin = yMin1;
	mParent1YMax = yMax1;
	mParent2YMin = yMin2;
...
void StL_LbarPiPFilter::SetMode(int val)
{
	mMode = val;
	//cout<<"StL_LbarPiPFilter::SetMode to mMode = "<<mMode<<endl;
}
