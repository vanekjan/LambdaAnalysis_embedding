...
StDiLambdaBarPiPFilter::StDiLambdaBarPiPFilter():StarFilterMaker("LambdaPiP")
{
...
//_______________________________________________________________
StDiLambdaBarPiPFilter::~StDiLambdaBarPiPFilter()
{
	delete nEvents;
}
//_______________________________________________________________
Int_t StDiLambdaBarPiPFilter::Filter( StarGenEvent *mEvent )
{
    ...
    { 
      firstLamdaFound = 1;
			...
			continue; //continue after first Lambda-bar is found
...
void  StDiLambdaBarPiPFilter::SetDauKine(double ptMin1, double ptMax1, double etaMin1, double etaMax1, double phiMin1, double phiMax1, double ptMin2, double ptMax2, double etaMin2, double etaMax2, double phiMin2, double phiMax2)
{
...
void StDiLambdaBarPiPFilter::SetParentRapidities(double yMin1, double yMax1, double yMin2, double yMax2)
{
	mParent1YMin = yMin1;
	mParent1YMax = yMax1;
	mParent2YMin = yMin2;
...
void StDiLambdaBarPiPFilter::SetMode(int val)
{
	mMode = val;
	//cout<<"StDiLambdaBarPiPFilter::SetMode to mMode = "<<mMode<<endl;
}
