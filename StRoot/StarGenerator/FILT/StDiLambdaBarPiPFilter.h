#ifndef StDiLambdaBarPiPFilter_h
#define StDiLambdaBarPiPFilter_h
...
class StDiLambdaBarPiPFilter : public StarFilterMaker
{
public:
  StDiLambdaBarPiPFilter(  );
  virtual ~StDiLambdaBarPiPFilter();
...
//#if 1 // we dont really need, but this triggers cons to create dictionary
  ClassDef(StDiLambdaBarPiPFilter,0);
//#endif
